...
module.exports = __webpack_require__("AQdt");
...
function Create(props) {
  ...
  const createCarHandler = async newCar => {
    var response = await _api_agent__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].Cars.create(newCar);
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(_components_meetups_NewCarForm__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
    ...
    carTypeData: props.carTypes
  });
}

/* harmony default export */ __webpack_exports__["default"] = (Create);
async function getStaticProps() {
  const res = await _api_agent__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].CarTypes.getAll();
  console.log(res);
  return {
    props: {
      carTypes: res
